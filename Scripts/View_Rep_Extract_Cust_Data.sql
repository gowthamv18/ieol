DROP VIEW DSS.VIEW_REP_EXTRACT_CUST_DATA;

CREATE OR REPLACE FORCE VIEW DSS.VIEW_REP_EXTRACT_CUST_DATA
(INVTYPE, INVNO, RNO, INVDATE, BRANCH, 
 REGDATE, AGINGDAYS, REGNO, MVARIANTCODE, MVARIANTDESC, 
 CHASSISNO, ENGINENO, REPAIRTYPE, INSCOMP, REVLBRTL, 
 REVLBINT, REVFS, REVWARLB, REVPARTSRTL, REVPARTSINT, 
 REVPARTSWTY, REVACCRTL, REVACCINT, REVACCWTY, REVLUBRTL, 
 REVLUBINT, REVLUBWTY, REVMATRTL, REVMATINT, REVMATWTY, 
 CAMPDISC, ADDDISCOUNT, PKGOPDISCAMT, PKGPARTDISCAMT, EDISCAMT, 
 INSEXCESSAMT, GSTEXCESS, GSTAMOUNT, VOUCHER, EVAMOUNT, 
 TTLINVAMT, ROUNDADJAMT, TOTALAMTPAYABLE, CURRMILEAGE, CUSTNAME, 
 PDPA, CUSTID, MOBILENO, HSETELNO, OFFICETELNO, 
 SENDERNAME, SENDERCONTACTNO, SVCADVISORID, SVCADVISORNAME, CUST_TYPE_DESC, 
 CUSTRACE, GENDER, POSTCODE, CITY, STATE, 
 CUSTADDRESS, CUSTCOMPLAINTREMARK, NEXTSVCMILEAGE, NEXTSVCDATE, OUTLETID, 
 CREATEDDATETIME, WTYSTATUS, OUTLETTYPE, TAXMETHOD, ROINVTYPECODE, 
 DISCLABOUR, DISCPARTS, DISCACC, DISCLUB, DISCLUBSUB, 
 DISCMTL, RDATE, COSTLABOUR, COSTPARTS, COSTPARTSWTY, 
 COSTACC, COSTACCWTY, COSTLUB, COSTLUBSUB, COSTLUBWTY, 
 COSTLUBSUBWTY, SUBLETCOST, SUBLETCOSTWTY, COSTMAT, COSTMATWTY, 
 MECHSTAFFID, MECHNAME)
AS 
SELECT
...
DROP SYNONYM DSSUSR.VIEW_REP_EXTRACT_CUST_DATA;

CREATE SYNONYM DSSUSR.VIEW_REP_EXTRACT_CUST_DATA FOR DSS.VIEW_REP_EXTRACT_CUST_DATA;


DROP SYNONYM DWQVUSR.VIEW_REP_EXTRACT_CUST_DATA;

CREATE SYNONYM DWQVUSR.VIEW_REP_EXTRACT_CUST_DATA FOR DSS.VIEW_REP_EXTRACT_CUST_DATA;


DROP SYNONYM FRMUSR.VIEW_REP_EXTRACT_CUST_DATA;

CREATE SYNONYM FRMUSR.VIEW_REP_EXTRACT_CUST_DATA FOR DSS.VIEW_REP_EXTRACT_CUST_DATA;


GRANT SELECT ON DSS.VIEW_REP_EXTRACT_CUST_DATA TO DSSUSR;

GRANT SELECT ON DSS.VIEW_REP_EXTRACT_CUST_DATA TO DWQVUSR;
